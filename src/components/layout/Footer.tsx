  ...
  return (
    <section className="snap-page ending-page" id="about">
      <div className="ending-content">
        ...
        <p className="ending-copyright">&copy; {new Date().getFullYear()} Lee&apos;s Blog. All rights reserved.</p>
        <button className="ending-back" onClick={scrollToTop} aria-label="回到顶部">
